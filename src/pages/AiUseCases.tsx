          ...
          {useCases.map((uc, i) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group relative rounded-2xl border border-border/50 bg-card overflow-hidden text-left transition-all duration-300 shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5 flex flex-col justify-between",
                  isLarge ? "p-6" : "p-5",
                  size
                )}
              >
